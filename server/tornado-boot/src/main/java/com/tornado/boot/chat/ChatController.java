...
public class ChatController {
    ...
    public Result<Map<String, Object>> models() {
        ...
        data.put("models", chatStreamService.models());
        data.put("default", chatStreamService.defaultModel());
    ...
    public Flux<ServerSentEvent<String>> stream(@RequestBody ChatStreamService.ChatReq req) {
    ...
    public Result<Void> stop(@PathVariable String streamId) {
        chatStreamService.stop(streamId);
        return Result.ok();
    }
    ...
    public Flux<ServerSentEvent<String>> resume(@PathVariable String threadId,
                                                @RequestBody ChatStreamService.HitlResumeReq req) {
        return chatStreamService.resume(threadId, req);
    }
}
